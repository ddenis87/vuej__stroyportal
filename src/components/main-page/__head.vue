<template>
  <div class="head">
    <div class="head-location">
      <div class="head-location__images">
      ...
      <div class="head-location__title">Благовещенск</div>
    ...
    <div class="head-navigation">
      <ul class="navigation">
        ...
        <span class="navigation__item-submenu" v-if="(item.SUBMENU)">
  ...
  data() {
    return {
      listItem: [
        ...
        {TITLE: 'Другие сервисы', SUBMENU: true},
      ]
    }
  }
}
